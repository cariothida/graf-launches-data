...
try{
 ...
 const call=async(name,args)=>{const response=await client.callTool({name,arguments:args},undefined,{timeout:45000});results.results.push({name,args,response});return response;};
